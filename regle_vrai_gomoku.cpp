...
// constructeur 
regle_vrai_gomoku::regle_vrai_gomoku()
{
	affichage_vrai_gomoku();
}

// permet d'afficher les regles du vrai gomoku
void regle_vrai_gomoku::affichage_vrai_gomoku()
{
	// variables
	...
	// affiche la page en plein ecran 
